...
# 데이터 경로로 지정한 폴더의 파일들을 file_list1에 리스트 형식으로 저장
# ex) file_list1 -> ['falldown_79_6255', 'falldown_324_8154', 'falldown_407_6980']
# ex) file_list2[0] -> ['rgb'] ./falldown_79_6255/rgb인경우
# len(file_list1) -> 3
```
